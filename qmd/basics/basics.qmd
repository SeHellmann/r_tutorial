...
In this case, this new element is a [vector](./qmd/final_exercise/data_structures.html#vector), which is a one dimensional collection of values. The `c()` stands for combine, or concatenate, and is the basic function for building a vector out of single elements.
...
Mainly we will use these logical operations to check which elements in a [vector](../data_structures/data_structures.qmd#vector) satisfy some requirements:
