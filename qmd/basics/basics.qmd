...
In this case, this new element is a [vector](../data_structures/data_structures.qmd#vector), which is a one dimensional collection of values. The `c()` stands for combine, or concatenate, and is the basic function for building a vector out of single elements.
