...
1.  Download the data set [`characters`](https://github.com/SeHellmann/r_tutorial/tree/main/raw_data) (in case you haven't already).
...
1.  Download the [`psych_stats`](https://github.com/SeHellmann/r_tutorial/tree/main/raw_data) data set  (in case you haven't already).
