...
We can also combine multiple logical vectors using [`&` ("and") and `|` ("or")](../basics/basics.qmd#or-and-and). For example, we might want to look at all german athletes before the year 2000:
